  ...
  return (
    <div className="w-full p-6 space-y-6 max-w-7xl mx-auto">
      ...
      <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
        ...
        <p className="text-gray-600">Access PDFs, Research Papers, Journals, and more.</p>
      </motion.div>
      ...
      <div className="flex flex-wrap gap-4 items-center">
        ...
        <select value={typeFilter} onChange={(e) => setTypeFilter(e.target.value)} className="p-2 bg-white shadow rounded-lg border">
