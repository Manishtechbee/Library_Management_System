    ...
    <footer className="bg-[#d1e3f4] py-2 text-center text-gray-800 text-sm">
      <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row justify-center items-center gap-4">
        ...
        <div className="flex gap-4 justify-center py-1">
          <a href="https://github.com/Manishtechbee/Library_Management_System" className="hover:text-blue-600">GitHub</a>
          <a href={!user?navigate("/login"):`dashboard/${user.role}/support`} className="hover:text-blue-600">Contact</a>
