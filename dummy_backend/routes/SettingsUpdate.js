...
router.put('/update-password/:id', async (req, res) => {
  ...
  db.query(sql, [studentId], async (err, results) => {
    ...
    db.query(
      ...
      // Log Activity
      logActivity(userId, "Updated account password").catch(console.error("Password cant be updated"));
...
router.put('/update-email/:id', (req, res) => {
  ...
  db.query(sql, [newEmail, newEmail, studentId], (err) => {
    ...
    // Log Activity
    logActivity(userId, "Updated account email").catch(console.error("Email cant be updated"));
...
router.put('/:id', (req, res) => {
  ...
  db.query(sql, [name, phone, address, name, studentId], (err, result) => {
    ...
    // Log Activity
    logActivity(userId, "Updated profile information").catch(console.error("Info cant be updated"));
