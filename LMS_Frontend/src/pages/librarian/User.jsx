    ...
    <div className={`p-6 space-y-6 max-w-7xl mx-auto ${textColor}`}>
      ...
      <div className="flex flex-wrap gap-4 items-center">
        ...
        <select
          ...
          className={`p-2 ${bgColor} ${textColor} border ${borderColor} shadow rounded-lg`}
        >
  ...
  <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
    <div className={`p-6 rounded-lg shadow-lg w-full max-w-md ${bgColor} ${textColor}`}>
      ...
      <div className="space-y-2">
        ...
        <p><span className="font-medium">Student ID:</span> {selectedUser.student_id || "N/A"}</p>
        <p><span className="font-medium">Department:</span> {selectedUser.department || "N/A"}</p>
        <p><span className="font-medium">Year:</span> {selectedUser.year || "N/A"}</p>
