...
export default function FacultyDashboard({darkMode}) {
  ...
  return (
   <>
   {darkMode?(<div className="space-y-8 p-6 pl-10">
  {/* Welcome Message *
  <motion.div
  ...
  >
    ...
    <NotificationBell userId={JSON.parse(localStorage.getItem("user"))?.id } darkMode={darkMode} />
  </motion.div>
  ...
  >
    <p className="text-gray-700 dark:text-gray-200 font-medium mb-2">Profile Completion</p>
    <div className="w-full bg-gray-200 dark:bg-gray-600 h-4 rounded-full relative group">
      <motion.div
    ...
    <p className="mt-1 text-sm text-gray-500 dark:text-gray-300">{profileCompletion}% completed</p>
  </motion.div>
  ...
  <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-stretch">
    ...
    >
      <div className="bg-white dark:bg-gray-800 shadow rounded-lg p-4 flex flex-col h-full">
        <h2 className="font-semibold text-gray-700 dark:text-gray-200 mb-2">Recent Activity</h2>
    ...
    >
      <div className="bg-white dark:bg-gray-800 shadow rounded-lg p-4 flex flex-col h-full">
        <h2 className="font-semibold text-gray-700 dark:text-gray-200 mb-2">Announcements</h2>
        {announcements.length === 0 ? (
          <p className="text-gray-500 dark:text-gray-300 flex-grow">No announcements available.</p>
        ) : (
          <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-300 flex-grow">
  ...
  >
    <h2 className="font-semibold text-gray-700 dark:text-gray-200 mb-4">Quick Access</h2>
  ...
  <motion.div
    ...
    className="bg-white dark:bg-gray-800 shadow rounded-lg p-4"
  >
    <h2 className="font-semibold text-gray-700 dark:text-gray-200 mb-4">Helpful Resources</h2>
